  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 pb-16">
        ...
        <p className="mt-2 text-[13.5px] leading-relaxed text-gray-700">① 광고주 회원은 소속 구성원을 팀 멤버로 초대할 수 있으며, 소유자 · 관리자 · 담당자의 권한을 부여할 수 있습니다.</p>
        <p className="mt-2 text-[13.5px] leading-relaxed text-gray-700">② 각 대화와 협업에는 담당자 한 명이 지정되며, <strong>담당자가 아닌 구성원은 해당 협업에 관여할 수 없습니다.</strong> 다만 소유자는 예외로 하되, 이 경우 상대에게 대리 발송 사실이 표시됩니다.</p>
